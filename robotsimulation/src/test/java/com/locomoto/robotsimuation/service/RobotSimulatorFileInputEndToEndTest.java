...
import com.locomoto.robotsimulation.service.RobotSimulatorService;

import java.io.IOException;
import java.net.URL;

import static com.locomoto.robotsimuation.service.RobotMatcher.isNotOnBoard;
import static com.locomoto.robotsimuation.service.RobotMatcher.isOnBoard;
import static com.locomoto.robotsimulation.model.Direction.EAST;
import static com.locomoto.robotsimulation.model.Direction.NORTH;
...
public class RobotSimulatorFileInputEndToEndTest {
    ...
    public void should_be_able_to_handle_non_text_file() throws IOException, ParseException {
        ...
        RobotSimulatorService simulator = new RobotSimulatorService(inputFileCommander, new NullPrintStream() );
        simulator.run();
    ...
    public void test_running_simulator_with_file_option() throws IOException, ParseException {
        ...
        RobotSimulatorService.main(new String[]{"-file",url.getPath()});
    }
